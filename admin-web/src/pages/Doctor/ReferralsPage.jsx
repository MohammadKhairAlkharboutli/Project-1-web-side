...
import { CalendarDays, ChevronLeft, ChevronRight, Inbox, Repeat2, Search, Send } from "lucide-react";
...
const VIEW_DETAILS = {
  sent: { heading: "Sent referrals", description: "External referrals you sent to another clinic or doctor.", empty: "Create an external referral from an active consultation.", icon: Send },
  ...
  self: { heading: "Self referrals", description: "Follow-up referrals that keep the patient under your care.", empty: "Create a follow-up referral from an active consultation.", icon: Repeat2 },
};
    ...
    try {
      ...
      const data = view === "sent"
        ...
        : view === "received"
          ...
          : await referralsApi.getSelfReferrals(params);

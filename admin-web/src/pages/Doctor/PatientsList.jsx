...
const MOCK_PATIENTS = [
  { id: 1, name: "Ahmad Mohammad Ali", gender: "Male", age: 34, phone: "+963 933 123 456", email: "ahmad.ali@example.com" },
  { id: 2, name: "Fatima Hassan Ibrahim", gender: "Female", age: 28, phone: "+963 944 987 654", email: "fatima.hassan@example.com" },
  { id: 3, name: "Omar Khaled Al-Mahmoud", gender: "Male", age: 42, phone: "+963 955 456 789", email: "omar.mahmoud@example.com" },
  { id: 4, name: "Sara Abdullah Khoury", gender: "Female", age: 25, phone: "+963 988 321 654", email: "sara.khoury@example.com" },
  { id: 5, name: "Samer Tarek Al-Abdullah", gender: "Male", age: 50, phone: "+963 991 789 123", email: "samer.abdullah@example.com" },
];
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs font-medium text-slate-500 mt-0.5">
            Access complete medical records and history for all clinic patients
          </p>
        </div>

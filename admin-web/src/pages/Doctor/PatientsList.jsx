...
import { doctorPatientsApi } from "@/api/doctorWorkflowApi";
...
export default function PatientsList() {
  ...
  const loadPatients = useCallback(async () => {
    ...
    setError("");
    try {
      const response = await doctorPatientsApi.getPatients({ page, limit, ...(debouncedSearch.trim() ? { search: debouncedSearch.trim() } : {}) });

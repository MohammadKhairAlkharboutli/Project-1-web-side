...
export default function DoctorLiveQueue() {
  ...
  return <div className="mx-auto w-full max-w-6xl space-y-6 pb-10"><PageHeader title="Today’s Patient Queue" description="Only checked-in appointments appear here." actions={<Button variant="outline" onClick={loadQueue}><RefreshCw size={15} /> Refresh</Button>} />
